...
var PdfHighlighter = function (_Component) {
  _inherits(PdfHighlighter, _Component);
  ...
  PdfHighlighter.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    if (this.props.highlights !== nextProps.highlights) {
      this.renderHighlights(nextProps);
    }
  };

  PdfHighlighter.prototype.shouldComponentUpdate = function shouldComponentUpdate() {
    return false;
  };
